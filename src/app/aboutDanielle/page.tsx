      ...
      <div className="grid grid-cols-1 gap-y-16 lg:grid-cols-2 lg:grid-rows-[auto_1fr] lg:gap-y-12">
        ...
        <div className="lg:order-first lg:row-span-2">
          ...
          <div className="mt-6 space-y-7 text-base text-zinc-600 dark:text-zinc-400">
            ...
            <p>Beyond her professional accomplishments, Danielle is a woman of profound kindness and a strong sense of responsibility towards her community. She runs a non-profit organization dedicated to assisting the homeless, providing them with water, food, and opportunities to rebuild their lives through conversation and hope. Her partnership with Great Harvest Bread Co in Nashville has further strengthened her mission to alleviate the hardships faced by the less fortunate. Danielle has also devoted over 450 hours to The American Cancer Society and doesn&#39;t plan to stop there. </p>
